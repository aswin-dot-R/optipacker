...
class Packer:
    ...
    def get_box(self, max_len_x, gap_len_y, max_len_y, gap_len_z, max_len_z):
        all_dims = {dim for box in self.boxes for dim in box.dims if not box.is_packed}
        ...
        for idx, box in enumerate(self.boxes):
            ...
            if box.dims in checked:
                print(f"Box {idx} is skipped due to violating input order.")
                continue
            else:
    ...
    def iterations(self):
        ...
        unique_permutations.add(self.pallet_dims)
